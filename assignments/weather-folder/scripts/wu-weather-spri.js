var requestURL = 'http://api.wunderground.com/api/2bd3e0c1308e8f04/conditions/q/OR/Springfield.json';
...
requestSec.open('GET', 'http://api.wunderground.com/api/2bd3e0c1308e8f04/forecast/q/OR/Springfield.json', true);
requestSec.send();
